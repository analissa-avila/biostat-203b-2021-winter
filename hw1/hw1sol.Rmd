...
echo "number of unique patients:"
#zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz |

## possible values of taken by `admission_type` and their count
echo "counts and values of 'admission_type':"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | tail -n +2 | awk -F ',' '{print $6}' | sort | uniq -c

## possible values of taken by `admission_location` and their count
echo "counts and values of 'admission_location':"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | tail -n +2 | awk -F ',' '{print $7}' | sort | uniq -c

## possible values of taken by `insurance` and their count
echo "counts and values of 'insurance':"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | tail -n +2 | awk -F ',' '{print $9}' | sort | uniq -c

## possible values of taken by `language` and their count
echo "counts and values of 'language':"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | tail -n +2 | awk -F ',' '{print $10}' | sort | uniq -c

## possible values of taken by `marital_status` and their count
echo "counts and values of 'marital_status':"
zcat /usr/203b-data/mimic-iv/core/admissions.csv.gz | tail -n +2 | awk -F ',' '{print $11}' | sort | uniq -c

## possible values of taken by `ethnicity` and their count
echo "counts and values of 'ethnicity':"
