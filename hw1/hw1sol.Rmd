...
**Solution:** Here is the link to my [course completion report](https://www.citiprogram.org/verify/?ke701e4f3-cd9e-4b2c-bb4d-9913085b5c57-40340162). Here is the link to my [course completion certificate](https://www.citiprogram.org/verify/?w30eef218-8d98-4cf0-836b-9b0c350f5427-40340162).
...
**Solution:**
The first command uses `>` which directs the output "hello, world" to a file named test1.txt. If that command is run again, new file named test1.txt will be created.
The second command uses `>>` which append the output "hello, world" to a file named test2.txt. If that command is run again, another line of "hello, world" will be appended to the existing test2.txt file.
